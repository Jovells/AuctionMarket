...
import { Auction, AuctionMarketNFT, MockStableCoin } from "../typechain-types";
  ...
  let auction: Auction,
    ...
    tokenId: bigint;
      ...
      beforeEach(async function () {
        ...
        const DNFT = await ethers.getContractFactory("AuctionMarketNFT");
        dnft = (await DNFT.deploy(auction.target)) as AuctionMarketNFT;
